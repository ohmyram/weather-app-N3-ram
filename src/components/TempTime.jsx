            ...
            <div className="flex flex-col w-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-customSecondaryDark p-6 rounded-md text-center">
                        ...
                        <p className="text-4xl font-bold mb-2 font-raleway">{(currentWeather.visibility / 1609.344).toFixed(1)}<span className="text-2xl font-normal"> miles</span></p>
                    </div>

                    <div className="bg-customSecondaryDark p-6 rounded-md text-center">
                        <p className="text-lg mb-2 font-raleway">Air Pressure</p>
                        <p className="text-4xl font-bold mb-2 font-raleway">{currentWeather.main.pressure}<span className="text-2xl font-normal">mb</span></p>
                    </div>
                </div>
